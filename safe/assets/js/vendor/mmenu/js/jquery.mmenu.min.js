...
!function (e) {
    ...
    function o(n, t) {
        ...
        var s = e("." + d.panel, t), o = s.filter("." + d.current);
    ...
    var a = "mmenu", l = "4.2.0";
    if (!e[a]) {
        var r = {$wndw: null, $html: null, $body: null, $page: null, $blck: null, $allMenus: null}, d = {}, c = {},
            u = {}, p = 0, h = 0;
        e[a] = function (e, n, t) {
            ...
            open: function () {
                ...
                s.each(function (t) {
                    var s = e(this), o = s.attr("id") || d.mm("m" + n.serialnr + "-p" + t);
                    s.attr("id", o)
                }), s.find("." + d.panel).each(function () {
                    var t = e(this), s = t.is("ul, ol") ? t : t.find("ul ,ol").first(), o = t.parent(),
                        i = o.find("> a, > span"), a = o.closest("." + d.panel);
                ...
                var n = this, t = this.$menu.attr("id");
            ...
            var n = window.document, t = window.navigator.userAgent,
                s = (document.createElement("div").style, "ontouchstart" in n),
                o = "WebkitOverflowScrolling" in n.documentElement.style, i = function () {
                    return t.indexOf("Android") >= 0 ? 2.4 > parseFloat(t.slice(t.indexOf("Android") + 8)) : !1
                }();
            e[a].support = {
                touch: s, oldAndroidBrowser: i, overflowscrolling: function () {
